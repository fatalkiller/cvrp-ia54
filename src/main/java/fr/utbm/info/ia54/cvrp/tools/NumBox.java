 ...
 * @author Thomas Bolz
 */
public class NumBox extends HBox {
    ...
    public NumBox(BigDecimal value, BigDecimal stepWidth) {
        this(value, stepWidth, NumberFormat.getInstance());
    }

    public NumBox(BigDecimal value, BigDecimal stepWidth, NumberFormat nf) {
        super();
